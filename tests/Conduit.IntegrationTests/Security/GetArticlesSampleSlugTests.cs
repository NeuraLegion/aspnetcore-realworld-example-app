...
{
    public class GetArticlesSampleSlugTests : IAsyncLifetime
    {
        ...
        [Fact]
        public async Task TestGetArticlesSampleSlug()
        {
            await _runner
                .CreateScan(new ScanSettings
                {
                    Tests = new[] { "sqli", "excessive_data_exposure", "csrf", "xss", "mass_assignment" },
                ...
                .Run(new ScanOptions
                {
                    ...
                    Url = $"{_baseUrl}/articles/sample-slug"
                });
        }
    }
}